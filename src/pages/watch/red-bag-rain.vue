<template>
  <div class="red-bag-rain" v-if="rainTime">
    ...
    <span class="jinbi" v-for="jinbi in jinbiList"
    ...
    <svg class="meteor" v-for="meteor in meteorList"
    ...
    <svg class="meteor" v-for="meteor in bigMeteorList"
         :style="{transform:`scale(${meteor.scale})`,left:`${meteor.left}px`,top:`${meteor.top}px`}"
  ...
  export default {
    ...
    methods: {
      ...
      selectRed (idx, e) {
        ...
        this.$emit('selectOk', this.selectBagList.length)
